...
pub fn final_scene() -> (World, Camera) {
    ...
    let block = HittableBuilder::new(Block::new(
        Point3::new(180.0, 220.0, 240.0),
        Point3::new(280.0, 340.0, 360.0),
        Metal::with_fuzz(Color::new(0.8, 0.4, 0.6), 0.2),
    ))
    .rotate_x_about(Vec3::new(220.0, 280.0, 300.0), 45.0)
    .rotate_y_about(Vec3::new(220.0, 280.0, 300.0), 45.0)
    .build();
    geometry.add(block);
    ...
    let resolution = Resolution::square(800);
